        ...
        <div className="container mx-auto w-5/6 sm:w-2/3 h-full">
            <div role="navigation" aria-label="Main" className="w-full bg-white dark:bg-gray-800 py-5 flex flex-col xl:flex-row items-start xl:items-center justify-between px-5 xl:px-10 shadow rounded-t">
                <div className="mb-4 sm:mb-0 md:mb-0 lg:mb-0 xl:mb-0 lg:w-1/2">
                    <a className="focus:outline-none  text-gray-800 dark:text-gray-100 text-lg font-bold">Job Postings</a>
                ...
                <div className="lg:hidden w-full relative mt-2 md:mt-4">
                    ...
                    <select aria-label="Selected tab" className="form-select block w-full p-3 border border-gray-300 rounded text-gray-600 dark:text-gray-100 appearance-none bg-transparent relative z-10">
                        ...
                        <option className="text-sm text-gray-600 dark:text-gray-100">Inactive</option>
                        <option selected className="text-sm text-gray-600 dark:text-gray-100">Active</option>
                        <option className="text-sm text-gray-600 dark:text-gray-100">Inactive</option>
                        <option className="text-sm text-gray-600 dark:text-gray-100">Inactive</option>
                    </select>
                </div>
                <div role="list" className="hidden lg:flex items-center lg:mt-6 xl:mt-0">
                    <button role="listitem" className=" focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 focus:outline-none font-normal flex justify-center items-center py-2 px-4 rounded mr-4 xl:mr-0 xl:ml-0 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-100 text-sm">Active</button>
                    <button role="listitem" className=" focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 focus:outline-none cursor-pointer font-normal flex justify-center items-center py-2 px-4 rounded mr-4 sm:mr-0 md:mr-0 lg:mr-0 xl:mr-0 sm:ml-4 md:ml-4 lg:ml-4 xl:ml-4 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 text-sm">Inactive</button>
                    <button role="listitem" className="focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 focus:outline-none cursor-pointer font-normal flex justify-center items-center py-2 px-4 rounded mr-4 sm:mr-0 md:mr-0 lg:mr-0 xl:mr-0 sm:ml-4 md:ml-4 lg:ml-4 xl:ml-4 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 text-sm">Inactive</button>
                    <button role="listitem" className=" focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 focus:outline-none cursor-pointer font-normal flex justify-center items-center py-2 px-4 rounded mr-4 sm:mr-0 md:mr-0 lg:mr-0 xl:mr-0 sm:ml-4 md:ml-4 lg:ml-4 xl:ml-4 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 text-sm">Inactive</button>
                </div>
            </div>
